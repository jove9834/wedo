...
class BladeCompiler {
    ...
    public function __construct($cachePath = NULL) {
        ...
        $this->cachePath = $cachePath ? $cachePath : DATA_PATH . DIRECTORY_SEPARATOR . 'views';
    }
    ...
    public function compileString($value)
    {
        $result = '';
        // 解析, 去掉Tag标签组件的应用
        // $value = TagFactory::getInstance()->setCompiler($this)->make($value);
        // $value .= TagFactory::getInstance()->getIncludeScriptString();
...
//             Logger::debug('match:{}', print_r($match, TRUE));
    ...
    protected function compileRawEchos($value)
    {
        ...
        {
            // Log::debug('compileRawEchos match:{}', print_r($matches, TRUE));
    ...
    protected function compileRegularEchos($value)
    {
        ...
        $callback = function($matches)
        {
            // Log::debug('compileRegularEchos match:{}', print_r($matches, TRUE));
            $whitespace = empty($matches[3]) ? '' : $matches[3].$matches[3];
    ...
    protected function compileEscapedEchos($value)
    {
        ...
        $callback = function($matches)
        {
            // Log::debug('compileEscapedEchos match:{}', print_r($matches, TRUE));
     ...
     * @return void
     */
    protected function compileSectionExists($expression) {
        return $this->compileIf("(\$__env->sectionExists{$expression})");
    }
     ...
     * @return void
     */
    protected function compileEndSectionExists($expression) {
