...
namespace Wedo\Translation;
use Wedo\Support\Collection;
...
class Translator extends NamespacedItemResolver {
	 ...
	 *
	 * @var \Wedo\Translation\LoaderInterface
	 */
	protected $loader;
	 ...
	 *
	 * @param  \Wedo\Translation\LoaderInterface $loader
	 * @param  string  $locale
	 * @return void
	 */
	...
	{
		$line = wd_array_val($this->loaded[$namespace][$group][$locale], $item);
